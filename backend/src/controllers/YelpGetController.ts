// src/controllers/YelpGetController.ts
...
class YelpGetController {
  ...
  public init() {
    this.app.get('/api/get-yelp-details/:yelpBusinessId', this.getYelpBusinessDetails);
  }

  private getYelpBusinessDetails = async (req: express.Request, res: express.Response) => {
